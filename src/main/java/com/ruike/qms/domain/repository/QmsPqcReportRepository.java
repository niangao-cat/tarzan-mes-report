...
import com.ruike.qms.domain.vo.QmsPqcReportChartVO2;
...
public interface QmsPqcReportRepository extends AopProxy<QmsPqcReportRepository> {
     ...
     * @param tenantId 租户ID
     * @param dto 查询信息
     * @author penglin.sui@hand-china.com 2020/1/27 21:34:22
     * @return com.ruike.qms.domain.vo.QmsPqcReportChartVO2
     */
    QmsPqcReportChartVO2 pqcReportEchartQuery(Long tenantId, QmsPqcReportDTO dto);
}
