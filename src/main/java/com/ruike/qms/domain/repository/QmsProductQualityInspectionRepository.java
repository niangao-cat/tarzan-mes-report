 ...
 * description
 *
 * @author faming.yang@hand-china.com 2021-05-14 10:26
 */
public interface QmsProductQualityInspectionRepository {
     ...
     */
    String selectOperationId(Long tenantId, String siteId, String operationName);
     ...
     */
    List<QmsProductQualityInspectionEoVO> selectAllEo(Long tenantId, String operationId,
     ...
     * @author faming.yang@hand-china.com 2021/5/17 15:26
     */
    List<QmsProductQualityInspectionNcEoVO> selectNcEo(Long tenantId, String siteId
            , String operationId, String startTime, String endTime);
     ...
     */
    List<String> selectSiteOutEo(Long tenantId, String eoId, String operationId, String creationTime);
     ...
     */
    List<QmsProductQualityInspectionNcEoVO> selectEoType(Long tenantId, String siteId, List<String> eoIdList);
     ...
     */
    List<QmsProductQualityInspectionNcRecordVO> selectNcRecord(Long tenantId, String siteId,
                                                               String operationId,
                                                               String startTime, String endTime);
}
