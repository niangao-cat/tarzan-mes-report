...
public class QmsIqcExamineReportRepositoryImpl implements QmsIqcExamineReportRepository {
    ...
    @Override
    @ProcessLovValue
    public List<QmsIqcExamineReportVO> iqcExamineReportExport(Long tenantId, QmsIqcExamineReportDTO dto) {
        return qmsIqcExamineReportMapper.iqcExamineReportQuery(tenantId, dto);
    }
}
