...
public interface HmeCommonReportRepository {
     ...
     * @param tenantId
     * @param dto
     * @author sanfeng.zhang@hand-china.com 2021/4/16 17:34
     * @return java.util.List<com.ruike.hme.domain.vo.HmeNonStandardReportVO2>
     */
    List<HmeNonStandardReportVO2> nonStandardProductReportExport(Long tenantId, HmeNonStandardReportVO dto);
}
