 ...
 *
 * @author: penglin.sui@hand-china.com 2021/07/12 19:42:00
 **/
@Data
@ExcelSheet(zh = "员工产量汇总")
public class HmeEmployeeAttendanceExportVO5 implements Serializable {
    private static final long serialVersionUID = -1276534534054289757L;
    ...
    @ApiModelProperty(value = "生产总时长")
    private BigDecimal totalProductionTimeDecimal;
