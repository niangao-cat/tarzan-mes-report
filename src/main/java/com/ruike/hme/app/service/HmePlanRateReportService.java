...
public interface HmePlanRateReportService {
     ...
     * @param dto 查询条件
     * @param response 响应流
     * @author chaonan.hu chaonan.hu@hand-china.com 2021/4/23 11:23:40
     * @return void
     */
    void planRateReportExport(Long tenantId, HmePlanRateReportRequestDTO dto, HttpServletResponse response) throws IOException;
}
