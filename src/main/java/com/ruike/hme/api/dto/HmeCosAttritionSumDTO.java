...
/**
 * @author sanfeng.zhang@hand-china.com 2021/7/30 11:14
 */
@Data
@ExcelSheet(zh = "COS工单损耗报表")
public class HmeCosAttritionSumDTO implements Serializable, Comparable<HmeCosAttritionSumDTO> {

    private static final long serialVersionUID = -7940960750896597646L;
    ...
    @Override
    public int compareTo(HmeCosAttritionSumDTO o) {
