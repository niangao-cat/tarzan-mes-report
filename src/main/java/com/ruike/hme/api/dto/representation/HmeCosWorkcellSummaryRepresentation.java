...
public class HmeCosWorkcellSummaryRepresentation {
    ...
    @ExcelColumn(title = "工单版本")
    private String productionVersion;

    @ApiModelProperty("版本描述")
    @ExcelColumn(title = "版本描述")
    ...
    @ApiModelProperty("来源工序作业ID")
    private String sourceJobId;

    public static HmeCosWorkcellSummaryRepresentation summary(HmeCosWorkcellSummaryRepresentation obj) {
        HmeCosWorkcellSummaryRepresentation result = new HmeCosWorkcellSummaryRepresentation();
...
//        result.setSnQty(obj.getSnQty());
        ...
        result.setProdLineCode(obj.getProdLineCode());
        result.setSourceJobId(obj.getSourceJobId());
        return result;
    }
    ...
    public boolean equals(Object o) {
        ...
        HmeCosWorkcellSummaryRepresentation that = (HmeCosWorkcellSummaryRepresentation) o;
        return Objects.equals(workOrderId, that.workOrderId)
                && Objects.equals(workOrderNum, that.workOrderNum)
                && Objects.equals(woQty, that.woQty)
                && Objects.equals(wafer, that.wafer)
                && Objects.equals(cosType, that.cosType)
                && Objects.equals(snQty, that.snQty)
                && Objects.equals(okQty, that.okQty)
                && Objects.equals(ngQty, that.ngQty)
                && Objects.equals(operatorName, that.operatorName)
                && Objects.equals(workcellId, that.workcellId)
                && Objects.equals(workcellCode, that.workcellCode)
                && Objects.equals(workcellName, that.workcellName)
                ...
                && Objects.equals(waferNum, that.waferNum)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(workOrderId, workOrderNum, woQty, wafer, cosType, snQty, okQty, ngQty, operatorName, workcellId, workcellCode, workcellName, creationDate, equipment, materialCode, materialName, operationId, operationCode, operationName, waferNum, operatorId, jobId, sourceJobId);
    }
}