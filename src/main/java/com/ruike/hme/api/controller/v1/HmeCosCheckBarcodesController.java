...
public class HmeCosCheckBarcodesController extends BaseController {
    ...
    public ResponseEntity<List<HmeCosCheckBarcodesVO>> export(@PathVariable("organizationId") String tenantId,
                                                              HmeCosCheckBarcodesDTO dto,
                                                              ExportParam exportParam,
                                                              HttpServletResponse response) {
        List<HmeCosCheckBarcodesVO> list = hmeCosCheckBarcodesService.exportCheckBarcodes(tenantId,dto,exportParam);
        return Results.success(list);
    }
}
