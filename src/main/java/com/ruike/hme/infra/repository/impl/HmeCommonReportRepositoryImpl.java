...
public class HmeCommonReportRepositoryImpl implements HmeCommonReportRepository {
    ...
    @Override
    @ProcessLovValue
    public List<HmeNonStandardReportVO2> nonStandardProductReportExport(Long tenantId, HmeNonStandardReportVO dto) {
        return hmeCommonReportMapper.nonStandardProductReportQuery(tenantId, dto);
    }
}
