...
import com.ruike.wms.api.dto.QmsInspectionTimeDTO;
import com.ruike.wms.api.dto.QmsReceivedQuantutyDTO;
import com.ruike.wms.api.dto.QmsRqAndItDTO;
import com.ruike.wms.api.dto.QmsSelectCardDataReturnDTO;
import com.ruike.wms.app.service.QmsReceivedInspectingBoardService;
import com.ruike.qms.infra.constant.QmsConstants;
import com.ruike.wms.infra.mapper.QmsReceivedInspectingBoardMapper;
...
public class QmsReceivedInspectingBoardServiceImpl implements QmsReceivedInspectingBoardService {
    ...
    public List<QmsReceivedQuantutyDTO> selectReceivedQuantity(Long tenantId) {
        ...
        qmsReceivedQuantutyDTOS.forEach(item -> {
            String actualReceiveDate = item.getActualReceiveDate();
            if (StringUtils.isNotEmpty(actualReceiveDate) && actualReceiveDate.length() > 5) {
                item.setActualReceiveDate(actualReceiveDate.substring(5));
            }
        });
