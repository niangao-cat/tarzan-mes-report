...
public interface WmsSummaryOfCosBarcodeProcessingRepository {
     ...
     * @param tenantId 租户ID
     * @param dto 查询条件
     * @author chaonan.hu chaonan.hu@hand-china.com 2021/6/29 09:49:22
     * @return java.util.List<com.ruike.wms.domain.vo.WmsSummaryOfCosBarcodeProcessingVO>
     */
    List<WmsSummaryOfCosBarcodeProcessingVO> listForExport(Long tenantId, WmsSummaryOfCosBarcodeProcessingDTO dto);
}
