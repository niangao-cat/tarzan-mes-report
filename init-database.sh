...
java -Dspring.datasource.url="jdbc:mysql://mes.basics.org:3306/mes_basics?useUnicode=true&characterEncoding=utf-8&useSSL=false" \
	 -Dspring.datasource.username=mes \
	 -Dspring.datasource.password=mes \
