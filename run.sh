...
dirName='tarzan-mes-report'
appName='tarzan-mes-report'
port=15060
...
mv ./target/$appName.jar /data/ruike/hwms/app/$appName.jar

# 启动项目
cd /data/ruike/hwms/
BUILD_ID=dontKillMe nohup java -jar -Dspring.profiles.active=dev \
